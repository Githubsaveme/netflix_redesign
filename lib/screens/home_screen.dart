...
import 'package:netflix_redesign/models/movie_model.dart';
import 'package:netflix_redesign/screens/movie_screen.dart';
...
class _HomeScreenState extends State<HomeScreen> {
                  ...
                  itemBuilder: (BuildContext context, int index) {
                    return Container(
                      ...
                      child: InkWell(
                        ...
                        child: ClipRRect(
                          borderRadius: BorderRadius.circular(10.0),
                          child: movieList[index].image.isNotEmpty
                              ? Image(
  ...
  Future fetchAlbum() async {
    ...
    if (response.statusCode == 200) {
      ...
      movieList = list.map((model) => MovieModel.fromJson(model)).toList();
      setState(() {});
    } else {
